...
osmRailwaysSource = (
    "/home/s.ryberg/data/OSM/geofabrik/railways/",
...
wdpaSource = (
    "/home/s.ryberg/data/protected/WDPA/WDPA_Apr2017-shapefile/clipped",
    "*.shp",
)
...
def evaluate_ROADS_SECONDARY(regSource, ftrID, tail):
    ...
    geom = geomExtractor(
        reg.extent,
        osmRoadsSource,
        r"fclass LIKE '%secondary%' OR fclass LIKE '%tertiary%'",
    )
