    ...
    * After all exclusions have been applied...
    ...
    def _compareIntermediates(s, metadata, intermediate):
        ...
        if (
            ...
            and meta_intermediate_compare == {k: metadata[k] for k in metadata if not k in metaNotConsidered}
        ):
            ...
            if intermediate is not None:
                ...
                if isfile(intermediate) and s.verbose:
                    ...
                    for k in (
                        ...
                        - {k: metadata[k] for k in metadata if not k in metaNotConsidered}.keys()
                    ):
